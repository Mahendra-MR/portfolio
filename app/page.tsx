...
export default function Home() {
  return (
    <div className="relative min-h-screen flex items-center justify-center text-center overflow-hidden vignette-bg">
      <FullAnimatedBackground />
      <div className="glass-card z-10 w-full max-w-2xl mx-auto">
        <PageWrapper>
